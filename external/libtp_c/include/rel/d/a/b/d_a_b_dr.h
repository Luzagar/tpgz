...
public:
    /* 0x05AC */ u8 field_0x5ac[0x05B4 - 0x05AC];
    /* 0x05B4 */ u8 field_0x5b4[0x05B8 - 0x05B4];
    /* 0x05B8 */ u8 field_0x5b8[0x05BC - 0x05B8];
    /* 0x05BC */ u8 field_0x5bc[0x05C0 - 0x05BC];
    /* 0x05C0 */ u8 field_0x5c0[0x0664 - 0x05C0];
    /* 0x0664 */ u8 field_0x664[0x0708 - 0x0664];
    ...
    /* 0x075E */ u8 field_0x75e[2];  // padding d'alignement
    ...
    /* 0x07ED */ u8 bitSw2;
    /* 0x07EE */ u8 bitSw3;
    /* 0x07EF */ u8 field_0x7ef[0x27A0 - 0x07EF];
    /* 0x27A0 */ u8 field_0x27A0[0x27A8 - 0x27A0];
    /* 0x27A8 */ u8 field_0x27a8[0x27AC - 0x27A8];
    ...
    /* 0x2810 */ u8 mInitHIO;
    /* 0x2811 */ u8 field_0x2811[0x2860 - 0x2811];
};
